...
def stack_slide_weights(mchirp):
    """Return intrinsic A_i^2/S_i_eff for every complete 30 s segment in band."""
    ...
    # Intrinsic A^2 includes only the leading inspiral amplitude f^(2/3).
    amplitude_squared = np.mean(frequencies ** (4.0 / 3.0), axis=1)
